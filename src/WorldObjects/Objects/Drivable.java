...
public abstract class Drivable extends WorldObject implements IsWorldObject {
    ...
    protected Drivable(Point position, Point2D direction, Point size, WorldObjectH objectType, boolean isStatic, RotationHandler rotationHandler, MoveHandler moveHandler, String type) {
        super(position, direction, size, objectType, isStatic,new StandardCollider(false),type);
