...
public class OldMoveHandlerDontTouchHasThePlague {
    ...
    public OldMoveHandlerDontTouchHasThePlague(){
        this.position=new Point(0,0);
        this.direction=new Point(1,0);
        this.turnAngle=90;
    }
    public OldMoveHandlerDontTouchHasThePlague(Point position, Point2D direction){
