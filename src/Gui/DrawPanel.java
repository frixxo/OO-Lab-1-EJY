...
public class DrawPanel extends JPanel{
    ...
    private void initializeHashmap(){
        ...
        imageMap.put(Saab95.class,new ImageWithSize("/Saab95.jpg",new Point (50,50)));
        imageMap.put(LamborghiniGallardo.class,new ImageWithSize("/LamborghiniGallardo.jpg",new Point (50,50)));
        imageMap.put(Scania.class,new ImageWithSize("/Scania.jpg",new Point (50,50)));
